<template>
  <section class="relative bg-white py-8 md:py-[60px]" style="background-color: #E6F2FF;">
    ...
    <div class="relative z-10 container max-w-7xl mx-auto">
      ...
      <div class="flex flex-col gap-2 md:flex-row md:justify-between flex-wrap">
        <div class="md:basis-[59.214%] p-[10px]">
          <div class="flex flex-col gap-[20px] order-2 md:order-1">
            ...
            <p class="text-base md:text-lg text-gray-700  text-[16px] leading-relaxed">
              At Legacy Solutions LLC, our dedicated team has helped clients reclaim substantial amounts — $58,000, $32,000, $78,000, and $16,000 — money that would have otherwise gone uncollected. We handle the process from start to finish, ensuring every recovery is smooth, professional, and confidential.
            </p>

            <!-- Bullet Points with Green Checkmarks -->
            <ul class="space-y-4">
              <li class="flex items-start space-x-3">
                <div class="flex-shrink-0 mt-1" style="color: #22C55E;">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <p class="text-base text-[16px] text-gray-700">We handle the research, paperwork, and coordination for you</p>
              </li>
              <li class="flex items-start space-x-3">
                <div class="flex-shrink-0 mt-1" style="color: #22C55E;">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-base text-[16px] text-gray-700">We don't get paid unless you do, it's completely risk-free</p>
              </li>
              <li class="flex items-start space-x-3">
                <div class="flex-shrink-0 mt-1" style="color: #22C55E;">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-base text-[16px] text-gray-700">We keep your information private and secure throughout the process</p>
              </li>
              <li class="flex items-start space-x-3">
                <div class="flex-shrink-0 mt-1" style="color: #22C55E;">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="flex flex-col md:flex-row md:justify-between gap-[20px]">
