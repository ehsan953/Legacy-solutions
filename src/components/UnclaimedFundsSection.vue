  ...
  <section class="bg-white py-8 md:py-[60px]">
    <div class="container max-w-7xl mx-auto">
      <div class="flex flex-col md:flex-row flex-wrap md:items-center">
        ...
        <div class="w-full md:basis-[40%] order-1 md:order-1 p-[10px] flex justify-center md:justify-start">
          <img 
        ...
        <div class="w-full md:basis-[60%] order-2 md:order-2 space-y-6 px-[20px] md:pr-[20px] md:pl-[30px]">
          ...
          <p class="md:text-lg text-gray-700 leading-relaxed text-left">
          ...
          <h3 class="font-outfit text-[18px] text-xl font-bold uppercase mt-6 md:mt-8 text-left" style="color: #00274D;">
            UNCLAIMED FUNDS COULD BE WAITING FOR YOU.
          </h3>

          <p class="text-base md:text-lg text-gray-700 leading-relaxed text-left">
