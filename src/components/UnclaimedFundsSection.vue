<template>
  <section class="bg-white py-8 md:py-[60px]">
    <div class="container max-w-7xl mx-auto">
      <div class="flex flex-col md:flex-row flex-wrap gap-[20px] items-center">
        <!-- Mobile: Image First, Desktop: Image Left -->
        <div class="w-full md:basis-[38%] order-1 md:order-1 p-[10px] flex justify-center md:justify-start">
          <img 
        ...
        <div class="w-full md:basis-[59%] lg:basis-[60%] order-2 md:order-2 space-y-6 px-[20px] md:px-0">
          <div class="flex flex-col md:flex-row md:items-center gap-4">
            ...
            <h2 class="font-outfit text-3xl md:text-4xl md:leading-[46px] font-bold uppercase leading-tight text-center md:text-left" style="color: #00274D;">
          ...
          <h3 class="font-outfit text-xl font-bold uppercase mt-6 md:mt-8 text-center md:text-left" style="color: #00274D;">
            UNCLAIMED FUNDS COULD BE WAITING FOR YOU.
          </h3>
