  ...
  <section class="bg-white py-8 md:py-16">
    <div class="container max-w-7xl mx-auto">
      <div class="flex flex-wrap gap-[20px]">
        ...
        <div class="relative flex justify-center md:justify-start basis-[39%] order-1 w-full rounded-xl p-[10px]">
          <div class="absolute inset-0 z-0 rounded-xl">
            <img 
              ...
              class="w-full max-w-lg h-auto object-cover rounded-xl"
            />
          </div>
        </div>

        <!-- Mobile: Text Second, Desktop: Text Right -->
        <div class="space-y-6 order-2 pl-[30px] pr-[20px] basis-[59.4%]">
