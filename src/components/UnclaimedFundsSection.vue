      ...
      <div class="flex flex-col md:flex-row flex-wrap gap-[20px] items-center">
        ...
        <div class="w-full md:basis-[60%] order-2 md:order-2 space-y-6 px-[20px] md:px-0">
          <div class="flex items-center gap-4">
            ...
            <h2 class="text-3xl font-bold uppercase leading-tight text-center md:text-left" style="color: #00274D;">
          ...
          <h3 class="text-xl font-bold uppercase mt-6 md:mt-8 text-center md:text-left" style="color: #00274D;">
            UNCLAIMED FUNDS COULD BE WAITING FOR YOU.
          </h3>
